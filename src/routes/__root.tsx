...
// ... wrap the <Outlet /> inside the component:
<LanguageProvider>
  <Outlet />
</LanguageProvider>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "μαργαριτα — Pizza · Pasta · Spritz · Coffee" },
      { name: "description", content: "Zero drama, full flavor. A playful pizza & spritz bar in Agra, Serres." },
      { property: "og:title", content: "μαργαριτα" },
