...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — μαργαριτα" },
      { name: "description", content: "Visit μαργαριτα in Agra, Serres 621 23. Open daily 9:00 – 1:00. Phone 2321 022440." },
      { property: "og:title", content: "Contact — μαργαριτα" },
      { property: "og:description", content: "Find us, call us, follow us." },
    ],
  }),
    ...
    <Layout>
      <section className="mx-auto max-w-7xl px-5 md:px-8 py-16 md:py-24">
        <div className="text-center mb-14">
          <span className="text-xs uppercase tracking-[0.3em] text-burgundy/60">Say ciao</span>
          <h1 className="font-display text-7xl md:text-9xl text-burgundy mt-4 lowercase">contact</h1>
        </div>

        <div className="grid lg:grid-cols-2 gap-10">
          <div className="space-y-6">
            <InfoBlock icon={<MapPin className="w-5 h-5" />} title="Location">
              <p className="text-xl">Agra, Serres 621 23</p>
              <p className="text-burgundy/70 text-sm mt-1">Greece</p>
            </InfoBlock>

            <InfoBlock icon={<Phone className="w-5 h-5" />} title="Phone">
              <a href="tel:+302321022440" className="text-xl hover:underline underline-offset-4">2321 022440</a>
            </InfoBlock>

            <InfoBlock icon={<Clock className="w-5 h-5" />} title="Opening Hours">
              <p className="text-xl">Monday – Sunday</p>
              <p className="text-burgundy/70">9:00 AM – 1:00 AM</p>
            </InfoBlock>
            ...
            <div className="bg-burgundy text-cream rounded-3xl p-8 relative overflow-hidden">
              ...
              <h3 className="font-display text-3xl">Follow the daisy.</h3>
              <p className="text-cream/80 mt-2 text-sm">Behind-the-scenes, new drops, late-night spritz.</p>
            ...
            <Link to="/reservations" className="inline-flex items-center gap-2 text-burgundy font-semibold hover:gap-3 transition-all">
              Or book a table → <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden border border-burgundy/15 min-h-[500px] bg-pink">
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-cream/95 backdrop-blur rounded-2xl p-4 flex items-center gap-3 border border-burgundy/15">
              ...
              <div>
                ...
                <p className="text-xs text-burgundy/70 mt-1">Agra, Serres 621 23</p>
              </div>
              <a
